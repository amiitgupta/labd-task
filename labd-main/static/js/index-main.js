...
$(document).ready(function () {
    ...
    $('.slid').owlCarousel({
        ...
        margin: 10,
        nav: true,
        navText: ["<img src='https://paytmofferlive.wpengine.com/wp-content/uploads/2019/07/left-arrow.png'>", "<img src='https://paytmofferlive.wpengine.com/wp-content/uploads/2019/07/right-arrow.png'>"],
        items: 1
    });
});